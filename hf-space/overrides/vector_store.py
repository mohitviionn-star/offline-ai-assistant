"""
HF Space override: same public API as backend/app/vector_store.py, but
uses file-backed embedded Qdrant when qdrant_mode=local so the whole RAG
stack runs in a single container.
"""
